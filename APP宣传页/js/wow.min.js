	...
	var a, 
		...
		a = function() {
			...
			return a.prototype.extend = function(a, b) { 
				var c, d;
				for(c in a) d = a[c], null != d && (b[c] = d); return b }, 
		...
		this.WOW = function() {
			...
			return 	d.prototype.defaults = { boxClass: "wow", animateClass: "animated", offset: 0, mobile: !0 }, 
					...
					d.prototype.applyStyle = function(a, b) {
						...
						return 	d = a.getAttribute("data-wow-duration"), 
								...
								this.animate(function(f) { 
									return function() { return f.customStyle(a, b, d, c, e) } 
								}(this)) 
					}, 
					...
					d.prototype.util = function() { return this._util || (this._util = new a) }, 
